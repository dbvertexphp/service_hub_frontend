...
import AddProfileForm from "Admin/layouts/addprofile/components/AddProfile";
            ...
            <Card>
              <MDBox p={2}>
                <MDBox p={2} style={{ textAlign: "center" }} lineHeight={0}>
                  <MDTypography variant="h5">Add Profile</MDTypography>
                </MDBox>
                <AddProfileForm /> {/* Use the AddUserForm component here */}
              </MDBox>
            </Card>
          </Grid>
        </Grid>
